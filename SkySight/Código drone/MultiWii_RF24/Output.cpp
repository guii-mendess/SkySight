/* =====================================================================
   ...
   Saídas PWM dos motores. Declarei as variáveis de soft-PWM que faltavam para a combinação Pro Micro + NRF24_RX.
   ===================================================================== */
...
#else
  #if defined(NRF24_RX)
    // SkySight: o Pro Micro com NRF24_RX precisava destas variáveis declaradas para as ISR do soft PWM.
