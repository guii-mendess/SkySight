/* =====================================================================
   ...
   Configuração do drone por: Guilherme Mendes

   Firmware base: MultiWii (multiwii.com). Este ficheiro de configuração
   foi ajustado por mim para o meu hardware:
     - Tipo de multicóptero: QUADX
     - Placa: Arduino Pro Micro (ATmega32U4) com A32U4ALLPINS
     - Recetor de rádio: NRF24L01 (NRF24_RX)
     - Sensor: MPU-6050 (GY-521), montado de cabeça para baixo
     - Correção da orientação do sensor (ver FORCE_*_ORIENTATION)
     - Buzzer no pino D4
   ===================================================================== */
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    independent sensors    ********************************/
      ...
      // MPU-6050 montado de cabeca para baixo: inverto o ROLL e o YAW (Z) nos dois sensores.
